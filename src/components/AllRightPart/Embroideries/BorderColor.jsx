...
// Updated BorderColor component to be controlled by props
const BorderColor = ({
  selectedColor,
  setSelectedColor,
  label,
  ...
  return (
    <div className="relative inline-block">
      ...
      <button
        ...
        className="w-[90px] h-[36px] border-gray-500 shadow-sm border cursor-pointer flex items-center justify-center"
        style={{
      ...
           {" "}
      {!isOpen && (
        <label className="mt-1 justify-center ml-8 block text-sm uppercase">
                    {label}       {" "}
        </label>
      )}
           {" "}
        ...
        <div className="absolute z-10 w-[300px] mt-1 bg-white border border-gray-300">
          ...
          <div className="grid grid-cols-4 gap-2 p-2">
            ...
            {allColors.map((color) => (
              <button
                key={color.name}
                className="w-[55px] h-[38px] border border-gray-200 cursor-pointer transition-shadow flex items-center justify-center"
                style={{
