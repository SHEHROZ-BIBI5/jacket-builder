...
const LeftChestSub = ({ data = {}, setData = () => {} }) => {
  ...
  const updateLeftChestData = (updates) => {
    setData({
      ...data,
      ...updates,
      activeTab: activeTab,
  ...
  const handleTabChange = (tab) => {
    setActiveTab(tab);
    updateLeftChestData({ activeTab: tab });
  };
    ...
    <div className="p-2 text-sm relative">
      ...
      {activeTab === "name" && (
        <NameTab
          ...
          setName={(val) => {
            setName(val);
            updateLeftChestData({ name: val });
          }}
          font={nameFont}
          setFont={(val) => {
            setNameFont(val);
            updateLeftChestData({ nameFont: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
            updateLeftChestData({ textColor: val });
          }}
      ...
      {activeTab === "letter" && (
        <LetterTab
          ...
          setLetters={(val) => {
            setLetters(val);
            updateLeftChestData({ letters: val });
          }}
          font={letterFont}
          setFont={(val) => {
            setLetterFont(val);
            updateLeftChestData({ letterFont: val });
          }}
          letterStyle={letterStyle}
          setLetterStyle={(val) => {
            setLetterStyle(val);
            updateLeftChestData({ letterStyle: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
          ...
          setBorderColor={(val) => {
            setBorderColor(val);
            updateLeftChestData({ borderColor: val });
          }}
          activeColorPicker={activeColorPicker}
          setActiveColorPicker={setActiveColorPicker}
        />
