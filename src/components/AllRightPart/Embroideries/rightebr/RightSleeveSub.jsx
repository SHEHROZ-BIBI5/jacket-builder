...
const RightSleeveSub = ({ data = {}, setData = () => {} }) => {
  ...
  const updateRightSleeveData = (updates) => {
    setData({
      ...data,
      ...updates,
      activeTab: activeTab,
  ...
  const handleTabChange = (tab) => {
    setActiveTab(tab);
    updateRightSleeveData({ activeTab: tab });
  };
    ...
    <div className="p-2 text-sm relative">
      ...
      {activeTab === "name" && (
        <NameTab
          ...
          setName={(val) => {
            setName(val);
            updateRightSleeveData({ name: val });
          }}
          font={nameFont}
          setFont={(val) => {
            setNameFont(val);
            updateRightSleeveData({ nameFont: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
            updateRightSleeveData({ textColor: val });
          }}
      ...
      {activeTab === "letter" && (
        <LetterTab
          ...
          setLetters={(val) => {
            setLetters(val);
            updateRightSleeveData({ letters: val });
          }}
          font={letterFont}
          setFont={(val) => {
            setLetterFont(val);
            updateRightSleeveData({ letterFont: val });
          }}
          letterStyle={letterStyle}
          setLetterStyle={(val) => {
            setLetterStyle(val);
            updateRightSleeveData({ letterStyle: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
          ...
          setBorderColor={(val) => {
            setBorderColor(val);
            updateRightSleeveData({ borderColor: val });
          }}
          activeColorPicker={activeColorPicker}
          setActiveColorPicker={setActiveColorPicker}
        />
      ...
      {activeTab === "image" && (
        <ImageTab
          ...
          setUploadedImage={(val) => {
            setUploadedImage(val);
            updateRightSleeveData({ image: val });
          }}
        />
      )}
