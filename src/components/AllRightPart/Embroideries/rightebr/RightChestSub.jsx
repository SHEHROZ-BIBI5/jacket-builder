...
const RightChestSub = ({ data = {}, setData = () => {} }) => {
  ...
  const updateRightChestData = (updates) => {
    setData({
      ...data,
      ...updates,
      activeTab: activeTab,
  ...
  const handleTabChange = (tab) => {
    setActiveTab(tab);
    updateRightChestData({ activeTab: tab });
  };

  useEffect(() => {
    // ❌ ye line remove kar di -> setActiveTab(data.activeTab || "name");
    setName(data.name || "");
    ...
    <div className="p-2 text-sm relative">
      ...
      {activeTab === "name" && (
        <NameTab
          ...
          setName={(val) => {
            setName(val);
            updateRightChestData({ name: val });
          }}
          font={nameFont}
          setFont={(val) => {
            setNameFont(val);
            updateRightChestData({ nameFont: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
            updateRightChestData({ textColor: val });
          }}
      ...
      {activeTab === "letter" && (
        <LetterTab
          ...
          setLetters={(val) => {
            setLetters(val);
            updateRightChestData({ letters: val });
          }}
          font={letterFont}
          setFont={(val) => {
            setLetterFont(val);
            updateRightChestData({ letterFont: val });
          }}
          letterStyle={letterStyle}
          setLetterStyle={(val) => {
            setLetterStyle(val);
            updateRightChestData({ letterStyle: val });
          }}
          textColor={textColor}
          setTextColor={(val) => {
            setTextColor(val);
          ...
          setBorderColor={(val) => {
            setBorderColor(val);
            updateRightChestData({ borderColor: val });
          }}
          activeColorPicker={activeColorPicker}
          setActiveColorPicker={setActiveColorPicker}
        />
      ...
      {activeTab === "image" && (
        <ImageTab
          ...
          setUploadedImage={(val) => {
            setUploadedImage(val);
            updateRightChestData({ image: val });
          }}
        />
      )}
