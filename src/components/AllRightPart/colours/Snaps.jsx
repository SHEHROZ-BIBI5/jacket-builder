...
const Snaps = ({ colors, handleColorChange, isOpen, toggleDropdown }) => {
  const [selectedColor, setSelectedColor] = useState(allColors[0]);

  const handleSelectColor = (color) => {
    setSelectedColor(color);
    if (typeof handleColorChange === "function") {
      handleColorChange("snaps", color.color); // ✅ snaps key
    }
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute left-[-260px] z-50 mt-1 bg-white border border-gray-300 w-[330px]">
            {/* Icon */}
            <div className="absolute -top-[12px] left-[295px] transform -translate-x-1/2">
