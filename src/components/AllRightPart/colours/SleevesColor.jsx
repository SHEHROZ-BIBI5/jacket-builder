...
const SleeveColor = ({ colors, handleColorChange, isOpen, toggleDropdown }) => {
  const [selectedColor, setSelectedColor] = useState(allColors[0]);

  const handleSelectColor = (color) => {
    setSelectedColor(color);
    if (typeof handleColorChange === "function") {
      handleColorChange("sleeves", color.color); // ✅ match state key
    }
  ...
  return (
    <div className="justify-center items-center p-1 font-sans grid grid-cols-2 gap-[1px]">
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute left-[-86px] z-50 mt-1 bg-white border border-gray-300 w-[330px]">
            {/* Icon */}
            <div className="absolute -top-[12px] left-[125px] transform -translate-x-1/2">
