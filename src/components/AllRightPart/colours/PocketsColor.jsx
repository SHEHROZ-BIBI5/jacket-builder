...
const PocketsColor = ({
  ...
  const handleSelectColor = (color) => {
    ...
    if (typeof handleColorChange === "function") {
      handleColorChange("pockets", color.color); // ✅ pockets key
    }
      ...
      <div className="relative">
        ...
        {isOpen && (
          <div className="absolute left-[-170px] z-50 mt-1 bg-white border border-gray-300 w-[330px]">
            {/* Icon */}
            <div className="absolute -top-[12px] left-[210px] transform -translate-x-1/2">
