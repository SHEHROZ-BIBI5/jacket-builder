...
const KnitLine = ({ handleColorChange, isOpen, toggleDropdown }) => {
  ...
  const handleSelectColor = (color) => {
    ...
    handleColorChange("knitLine", color.color);
    toggleDropdown(); // ✅ correct
  };
    ...
    <div className="justify-center items-center p-1 font-sans grid grid-cols-2 gap-[1px]">
      <div className="w-[80px] max-w-sm">
        <div className="relative">
          {/* Selected Button */}
          <button
            onClick={toggleDropdown} // ✅ correct
